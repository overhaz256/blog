 ...
 <header class="s-header s-header--opaque">
     ...
     <div class="s-header__logo">
         <a class="logo" href="index.php">
             <h2 style="color:white;font-family:monospace;display:table-cell;padding-top:15px;font-size:30px;">
                SpyCode</h2>
         </a>
     </div>
                ...
                <form role="search" method="get" class="s-header__search-form" action="search.php">
                    <label>
                        ...
                        <input type="search" class="s-header__search-field" placeholder="Search for..." value=""
                            name="query" title="Buscar:" autocomplete="off">
                    </label>
                    <input type="submit" class="s-header__search-submit" value="Search">
                </form>

                 <a href="#0" title="Close Search" class="s-header__overlay-close">Cerrar</a>
