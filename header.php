...
<header class="s-header">
    ...
    <div class="s-header__logo">
        <a class="logo" href="index.php">
            <h2 style="color:white;display:table-cell;padding-top:15px;font-size:30px;" ><img src="LOGO3.ico"> SpyCode</h2>
        </a>
        
    </div>
    <!-- Agregar margin:500px para que el menú este centrado-->
    <div class="row s-header__navigation" style="margin:550px;">
        ...
        <nav class="s-header__nav-wrap">
            ...
            <ul class="s-header__nav">
                ...
                <li class="has-children">
                    <a href="category.php" title="">Categorías</a>
                    <ul class="sub-menu">
                        <?php 
                ...
                <li><a href="about.php" title="">Acerca de</a></li>
        ...
        <div class="s-header__search-inner">
            <div class="row wide">
                <form role="search" method="get" class="s-header__search-form" action="search.php">
                    <label>
                        <span class="h-screen-reader-text">Buscar:</span>
                ...
                <a href="#0" title="Cerrar búsqueda" class="s-header__overlay-close"></a>  
            </div>
        </div>
    </div>
