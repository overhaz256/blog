...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>SpyCode © | <?php echo $blogMetaTitle; ?></title>
...
<body id="top">
                    ...
                    <div class="s-content__primary">
                        ...
                        <div class="s-content__entry-meta">
                            ...
                            <div class="entry-author meta-blk">
                                <div class="author-avatar">
                                    <img class="avatar" src="images/levi.jpg" alt="">
                                </div>
                                <div class="byline">
                                    <span class="bytext">Publicado por</span>
                                    <a href="#">SpyCode TEAM</a>
                                </div>
                            </div>
                        ...
                        <div class="s-content__pagenav">
                            ...
                            <?php
                                ...
                                $sqlGetPreviousBlog = "SELECT * FROM blog_post WHERE n_blog_post_id = (SELECT max(n_blog_post_id) FROM blog_post WHERE n_blog_post_id < '".$blogPostId."')";              
                                $queryGetPreviousBlog = mysqli_query($conn, $sqlGetPreviousBlog);

                                $sqlGetNextBlog = "SELECT * FROM blog_post WHERE n_blog_post_id = (SELECT min(n_blog_post_id) FROM blog_post WHERE n_blog_post_id > '".$blogPostId."')";
        ...
        <div class="comments-wrap">
            ...
            <div id="comments" class="row">
                <div class="column large-12">
                    ...
                    <h3><?php echo $numComments; ?> Comentarios</h3>
                                ...
                                <div class="comment__info">
                                    ...
                                    <div class="comment__meta">
                                        ...
                                        <div class="comment__reply">
                                            <a class="comment-reply-link" href="#reply-comment-section" onclick="prepareReply('<?php echo $commentId; ?>');">Responder</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row comment-respond" id="reply-comment-section">
                ...
                <div id="respond" class="column">
                    ...
                    <p style="color:green;display:none;" id="reply-success">Tu respuesta fue agregada satisfactoriamente. Actualiza tu navegador para visualizarla.</p>
                        ...
                        <fieldset>
                            ...
                            <div class="form-field">
                                <input name="replyCName" id="replyCName" class="h-full-width h-remove-bottom"
                                    placeholder="Tu Nombre" value="" type="text">
                            </div>
                            <div class="form-field">
                                <input name="replyCEmail" id="replyCEmail" class="h-full-width h-remove-bottom"
                                    placeholder="Tu Email" value="" type="text">
                            </div>
                            ...
                            <br>
                            <input name="submit" id="submitReplyForm" class="btn btn--primary btn-wide btn--large h-full-width" value="Responder" type="submit">
                            <input name="submit" id="addComment" class="btn btn--primary btn-wide btn--large h-full-width" value="Agregar Comentario" onclick="prepareComment();">
                        </fieldset>
                    </form> <!-- end form -->
            ...
            <div class="row comment-respond" id="add-comment-section">
                ...
                <div id="respond" class="column">
                    ...
                    <h3>
                        Agregar Comentario
                        <span>Tu dirección de e-mail no será publicada.</span>
                    </h3>

                    <p style="color:green;display:none;" id="comment-success">Tu comentario fue agregado.</p>
                    ...
                    <form name="commentForm" id="commentForm">
                        <fieldset>
                            ...
                            <div class="form-field">
                                <input name="cName" id="cName" class="h-full-width h-remove-bottom" placeholder="Tu Nombre" value="" type="text">
                            </div>
                            <div class="form-field">
                                <input name="cEmail" id="cEmail" class="h-full-width h-remove-bottom" placeholder="Tu Email" value="" type="text">
                            </div>
                            <div class="message form-field">
                                <textarea name="cMessage" id="cMessage" class="h-full-width" placeholder="Tu Mensaje"></textarea>
                            </div>
                            <br>
                            <input name="submit" id="submitCommentForm" class="btn btn--primary btn-wide btn--large h-full-width" value="Enviar" type="submit">
                        </fieldset>
                    </form> <!-- end form -->
    ...
    <script>
        ...
        function prepareReply(commentId) {
            ...
            $("#reply-h3").html("Responder a: " + authorName);
        ...
        $(document).on('submit', '#commentForm', function(e) {
            ...
            if (!name || !email || !comment) {
                ...
                $("#comment-error").html("Porfavor completa todos los campos.");
            } else if (name.length > 50) {
                $("#comment-error").css("display", "block");
                $("#comment-error").html("El campo de nombre solo puede contener un máximo de 50 caracteres.");
            } else if (email.length > 50) {
                $("#comment-error").css("display", "block");
                $("#comment-error").html("El campo de email solo puede contener un máximo de 50 caracteres.");
            } else if (comment.length > 500) {
                $("#comment-error").css("display", "block");
                $("#comment-error").html("El comentario solo puede contener un máximo de 500 caracteres.");
            } else if (checkEmail(email) == false) {
                $("#comment-error").css("display", "block");
                $("#comment-error").html("Porfavor ingresa un e-mail válido.");
            } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "success") {
                            ...
                            $("#comment-error").css("display", "block");
                            $("#comment-error").html("Ocurrió un error al agregar tu comentario, por favor intentalo más tarde.");
                        }
                    }
                });
            }
        ...
        $(document).on('submit', '#replyForm', function(e) {
            ...
            if (!name || !email || !reply) {
                ...
                $("#reply-error").html("Porfavor completa todos los campos.");
            } else if (name.length > 50) {
                $("#reply-error").css("display", "block");
                $("#reply-error").html("El campo de nombre solo puede contener un máximo de 50 caracteres.");
            } else if (email.length > 50) {
                $("#reply-error").css("display", "block");
                $("#reply-error").html("El campo de email solo puede contener un máximo de 50 caracteres.");
            } else if (reply.length > 500) {
                $("#reply-error").css("display", "block");
                $("#reply-error").html("El mensaje solo puede contener un máximo de 500 caracteres.");
            } else if (checkEmail(email) == false) {
                $("#reply-error").css("display", "block");
                $("#reply-error").html("Porfavor ingresa un e-mail válido.");
            } else if (!parentId){
                $("#reply-error").css("display", "block");
                $("#reply-error").html("Hubo un error inesperado. Intenta actualizar la página.");
            } else {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "success") {
                            ...
                            $("#reply-error").css("display", "block");
                            $("#reply-error").html("Ocurrió un error al agregar tu respuesta, por favor intentalo más tarde.");
                        }
                    }
                });
            }
